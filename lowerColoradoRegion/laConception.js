/* 
  ...
  the subwatersheds in the Rio De La Conception basin using Landsat annual 
...
// The Rio De La Conception basin.
var laConception = ee.FeatureCollection("USGS/WBD/2017/HUC06").filter(ee.Filter.eq('huc6', '150802'));

// The 264 subwatersheds within the Rio De La Conception basin.
var subwatersheds = ee.FeatureCollection("USGS/WBD/2017/HUC12")
  .filter(ee.Filter.and(
    ee.Filter.gte('huc12','150802000000'),
    ee.Filter.lt('huc12','150803000000')
  )
);

// Loop through years.
for (var i = 2020; i >= 1985; i--){
  var image = utils.makeAnnual(laConception, i);
  ...
  Export.table.toCloudStorage({
    collection: data, 
    description: 'laConception_export_' + iStr,
    bucket: 'YOUR-GOOGLE-CLOUD-STORAGE-BUCKET',
    fileNamePrefix: 'laConception_subwatersheds_' + iStr,
    fileFormat: 'CSV',
  });
}